...
#line 154 "parser.cpp" /* yacc.c:352  */
};
...
{
       0,    41,    41,    44,    45,    48,    48,    49,    52,    53,
      56,    57,    60,    64,    65,    66,    69,    72,    73,    76,
      77,    78,    79,    80,    81,    84,    85,    86,    89,    89,
...
#line 1332 "parser.cpp" /* yacc.c:1652  */
    break;

  case 13:
#line 64 "parser.y" /* yacc.c:1652  */
    { (yyval.varvec) = new VariableList(); }
#line 1338 "parser.cpp" /* yacc.c:1652  */
    break;
...
#line 72 "parser.y" /* yacc.c:1652  */
    { (yyval.expr) = new NIdentifier((yyvsp[0].string)->c_str()); delete (yyvsp[0].string); }
#line 1362 "parser.cpp" /* yacc.c:1652  */
    break;

  case 18:
#line 73 "parser.y" /* yacc.c:1652  */
    { (yyval.expr) = new NDouble(atof((yyvsp[0].string)->c_str())); delete (yyvsp[0].string); }
#line 1368 "parser.cpp" /* yacc.c:1652  */
    break;
